...
class Dataset(object):
    ...
    def find_match(self):
        ...
        for pair in related_pairs:
            match = self.kb.get_triples_for_entities(pair[0], pair[1])
    ...
    def build_dataset(self, include_positive=True, sampling_rate=0.1, seed=1):
        ...
        # here you are creating a separate dataset for each relation
        
        # create a random sample of 10% of all unrelated paris found from corpus, to downsample 
        ...
        # 1)
        # go through all of the triples from the kb
        # put them into the dataset with the label "true"
        # this creates your positive examples
        
        # 2)
        # then go through unrelated pairs from the corpus 
        # for each relation in kb, label every relation as "false"
